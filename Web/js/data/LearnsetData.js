/**
 * LearnsetData.js — Maps each of the 24 Sprite races to their learnable abilities.
 * Ported from SpriteLearnsets.gd.
 *
 * Each race learns 8-12 abilities total, including element-matched and class-matched moves.
 * Entries are ordered by learn_level.
 *
 * @typedef {Object} LearnsetEntry
 * @property {number} ability_id
 * @property {number} learn_level
 * @property {boolean} is_starting
 *
 * @typedef {{ [raceId: number]: LearnsetEntry[] }} LearnsetMap
 */
