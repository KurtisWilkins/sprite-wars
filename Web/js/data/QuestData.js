/**
 * QuestData.js — Static database of the first 10 main story quests.
 * Ported from MainQuestData.gd.
 *
 * @typedef {Object} QuestObjective
 * @property {string} type — "talk_to_npc", "reach_area", "win_battle_condition",
 *                           "catch_sprite", "complete_temple", "defeat_enemies"
 ...
 * @property {{ item_id: number, count: number }[]} items
 * @property {string[]} unlocks
 *
 * @typedef {Object} Quest
 * @property {number} quest_id
 * @property {string} title
 * @property {string} description
 * @property {string} quest_type
 * @property {string} quest_giver_npc_id
 * @property {QuestObjective[]} objectives
 * @property {number[]} prerequisite_quest_ids
